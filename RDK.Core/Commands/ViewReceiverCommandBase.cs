namespace RDK.Commands
{
    ...
    public abstract class ViewReceiverCommandBase<T> : CommandBase, ICommand
    {
        ...
        protected ViewReceiverCommandBase(Action<T> execute)
            : this(execute, null)
        {
        }
        ...
        protected ViewReceiverCommandBase(Action<T> execute, Func<T, bool> canExecute)
        {
